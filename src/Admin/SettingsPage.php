...
final class SettingsPage
{
    ...
    private function renderFrontendTab(array $settings): void
    {
        ...
        <section class="wc26-admin-panel">
            ...
            <p class="description"><?php echo esc_html__('El navegador consulta el endpoint local del plugin una vez por minuto. API-Football sigue protegida por cache y lock server-side.', WC26_WIDGET_TEXT_DOMAIN); ?></p>
            <p class="description">
