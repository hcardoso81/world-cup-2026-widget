...
final class ApiFootballClient
{
    ...
    private function mockSchedule(): array
    {
        return [
            ...
            '2026-06-11' => [
                $this->mockMatch('13:00', 'Not Started', 'NS', null, 'Estadio Akron', 'Group Stage - Matchday 1', 19, 'Denmark', 28, 'Serbia', null, null),
                $this->mockMatch('16:00', 'Not Started', 'NS', null, 'Lincoln Financial Field', 'Group Stage - Matchday 1', 29, 'Poland', 30, 'Austria', null, null),
                $this->mockMatch('19:00', 'Not Started', 'NS', null, 'Arrowhead Stadium', 'Group Stage - Matchday 1', 32, 'Costa Rica', 33, 'Ecuador', null, null),
                $this->mockMatch('22:00', 'Not Started', 'NS', null, 'Snapdragon Stadium', 'Group Stage - Matchday 1', 34, 'Qatar', 35, 'Tunisia', null, null),
            ],
            '2026-06-12' => [
                $this->mockMatch('13:00', 'Not Started', 'NS', null, 'Estadio BBVA', 'Group Stage - Matchday 1', 36, 'Peru', 37, 'Paraguay', null, null),
                $this->mockMatch('16:00', 'Not Started', 'NS', null, 'Camping World Stadium', 'Group Stage - Matchday 1', 38, 'Cameroon', 39, 'Nigeria', null, null),
                $this->mockMatch('19:00', 'Not Started', 'NS', null, 'Rose Bowl', 'Group Stage - Matchday 1', 40, 'Egypt', 41, 'Iran', null, null),
                $this->mockMatch('22:00', 'Not Started', 'NS', null, 'Allegiant Stadium', 'Group Stage - Matchday 1', 42, 'Sweden', 43, 'Norway', null, null),
            ],
            '2026-06-13' => [
                $this->mockMatch('13:00', 'Not Started', 'NS', null, 'Yankee Stadium', 'Group Stage - Matchday 1', 44, 'Turkey', 45, 'Greece', null, null),
                $this->mockMatch('16:00', 'Not Started', 'NS', null, 'Inter&Co Stadium', 'Group Stage - Matchday 1', 46, 'Wales', 47, 'Scotland', null, null),
                $this->mockMatch('19:00', 'Not Started', 'NS', null, 'Bank of America Stadium', 'Group Stage - Matchday 1', 48, 'Ireland', 49, 'Ukraine', null, null),
